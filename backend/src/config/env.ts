...
export const ENV = {
  ...
  // JWT
  JWT: {
    ACCESS_SECRET: process.env.JWT_ACCESS_SECRET || "treemint_jwt_super_secure_access_secret_2026_key",
    REFRESH_SECRET: process.env.JWT_REFRESH_SECRET || "treemint_jwt_super_secure_refresh_secret_2026_key",
